package net.notejam.spring.infrastructure.presentation.dialect;

import static net.notejam.spring.infrastructure.presentation.dialect.ProcessorUtil.getValue;
